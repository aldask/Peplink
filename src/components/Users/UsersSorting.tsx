...
const UsersSorting = ({ sortOption, onChange }: UserSortingProps) => {
  return (
    <select
      ...
      className="lg:text-left text-center w-full lg:w-auto bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-4 sm:py-2 sm:px-6 rounded-xl shadow hover:shadow-md focus:ring-2 focus:ring-amber-300 cursor-pointer transition "
    >
